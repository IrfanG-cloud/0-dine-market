...
export default function Header() {
  ...
  return (
    <nav className='w-full justisfy-between fixed top-0 right-0 z-20 bg-white'>
        <div className='justify-between px-6 mx-auto md:flex md:items-center md;px-8 lg:max-w-8xl'>
            <div className='w-full flex justify-between md:items-center md:py-0'>
                <div>
                    <Link href="/">
                        <h1 className='text-xl pt-1 text-[var(--primary-color)] md:text-2xl md:pt-0'>O-Dine-Market</h1>
                    </Link>
                </div>
                <div className={`bg-white flex-1 justify-self-center pb-3 mt-13 md:block md:pb-0 md:mt-0 ${ navbar ? 'p-15 md:p-0 block' : 'hidden'}`}>
                <ul className='h-screen ml-2 justify-start items-center mt-20 md:h-auto md:flex md:ml-40 md:mt-0'>
                        <li className='after:text-left p-3 md:mb-4font-bold text-2xl md:text-[16px] md:px-4 hover:text-[var(--primary-color)] cursor-pointer'>
                ...
                <div className='hidden border borbor-l-0 p-1 ml-2 mr-2 md:flex'>
                    ...
                    <input className='ml-2 mr-2' type="text" placeholder="What you looking for"  />
                </div>
